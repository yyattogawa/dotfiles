...
`dotspacemacs/user-config' first."
  ...
  ;; howm
  (add-to-list 'load-path "~/.emacs.d/manual-install/howm-1.4.4")
  ;; 言語
  ...
  ;; calfw
  (add-to-list 'load-path "~/.emacs.d/manual-install/calfw")
  (require 'calfw)
  (require 'calfw-howm)
